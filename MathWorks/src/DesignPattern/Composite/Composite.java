...
resources:      https://java-design-patterns.com/patterns/composite/


Composite:
    1. Composite lets clients treat individual objects and compositions of objects uniformly.
    2. Like a Tree structure
...
public abstract class LetterComposite {
    ...
    public void add(LetterComposite letter) {           // most basic methods defines in the toppest class
        children.add(letter);
    }
...
// Word extends LetterComposite
public class Word extends LetterComposite {
    public Word(List<Letter> letters) {         // obtains a Letter array and add to the hierachy
...
// Sentence extends LetterComposite
